...
| 3 	| Matrix Factorization Techniques for Recommender Systems 	| Koren et al. 	| Yahoo Research 	| 2009 	| COMPUTER 	| [MF](Recommendation%20Technology/3_MF.md) | [DOI](https://ieeexplore.ieee.org/abstract/document/5197422) | [Github](https://github.com/harshraj11584/Paper-Implementation-Matrix-Factorization-Recommender-Systems-Netflix) | [知乎](https://zhuanlan.zhihu.com/p/28577447?from_voters_page=true) |
...
| 6 	| Variational Autoencoders for Collaborative Filtering 	| Liang et al.	| Netflix 	| 2018 	| WWW	| [MultVAE](Recommendation%20Technology/6_MultVAE.md) | [arXiv](https://arxiv.org/abs/1802.05814) | [Github](https://github.com/dawenl/vae_cf) | - |
| 7 	| LightGCN: Simplifying and Powering Graph Convolution Network for Recommendation 	| He et al.	| University of Science and Technology of China 	| 2020 	| ACM SIGIR	| [LightGCN](Recommendation%20Technology/7_LightGCN.md) | [DOI](https://dl.acm.org/doi/10.1145/3397271.3401063) | [Github](https://github.com/kuandeng/LightGCN) | - |
| 8 	| Heterogeneous Global Graph Neural Networks for Personalized Session-based Recommendation 	| Pang et al.	| Tongji University 	| 2022 	| ACM WSDM	| [HG-GNN](Recommendation%20Technology/8_HG-GNN.md) | [DOI](https://dl.acm.org/doi/10.1145/3488560.3498505) | [Github](https://github.com/0215Arthur/HG-GNN) | - |
| 9 	| Session-based Recommendations with Recurrent Neural Networks 	| Hidasi et al.	| Gravity R&D Inc. 	| 2015 	| Preprint(ICLR)	| [GRU4Rec](Recommendation%20Technology/9_GRU4Rec.md) | [DOI](http://arxiv.org/abs/1511.06939) | [Github](https://github.com/hidasib/GRU4Rec) | - |
| 10 	| BERT4Rec: Sequential Recommendation with Bidirectional Encoder Representations from Transformer 	| Sun et al.	| Alibaba Group 	| 2019 	| ACM CIKM	| [BERT4Rec](Recommendation%20Technology/10_BERT4Rec.md) | [DOI](https://dl.acm.org/doi/10.1145/3357384.3357895) | [Github](https://github.com/FeiSun/BERT4Rec) | - |
